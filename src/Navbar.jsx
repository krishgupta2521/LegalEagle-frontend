            ...
            <header className="w-full">
                <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center">
                        <img src="https://s3-alpha-sig.figma.com/img/20f5/6af6/75e624743590a6a6abc9861d08bc2e28?Expires=1745798400&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=eqDDS~pWI-fQtD6eNGlBlzueTolXEX5gVYBW8Uv-imWAHkJTMksnskMiMdfkT~t0rVgCo0f3bppDkZ57pgyhmvx~6PW0DbZLpB2CBIbwOYlSYq5zBKowTz3a1DL3zD8xSFhP5CYL-ayL5rhueChfgQnqBsjbopLl9my4lmcryOvzP0TSmXAuDxYeSS8cmFrnALv-gN574TbOWdHXuJPVDYMLDC0SUHkeDf3spoUVSY9S1qQLUVjipadZtQVC5GNoZOcg2vOApc2joAz9dNGcBottCcw2mue1ckNS5akZl5kVzSutelzO-W0q4aDkZ83Fp4u~Hh6~jefrO6OO2MUiDw__" alt="Logo" className="h-16 w-16" />
                        <span className="text-3xl font-bold font-['Righteous'] text-[#0B0B5C]">Legal Eagle</span>
                    </div>
